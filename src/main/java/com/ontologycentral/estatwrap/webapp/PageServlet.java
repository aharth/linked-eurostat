        ...
        try {
            ...
            String query =
                    "BASE <https://estatwrap.ontologycentral.com/>\nPREFIX dim: <ds/" + id + "#>\nPREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>\nPREFIX qb: <http://purl.org/linked-data/cube#>\nPREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>\nPREFIX skos: <http://www.w3.org/2004/02/skos/core#>\n\nSELECT ?time ?value ?geo\nFROM <da/"
                            ...
                            + ">\nFROM <cl/geo>\nWHERE {\n\t?obs qb:dataSet <da/"
                            + id
                            + "#ds> .\n\t?obs dim:dim-TIME_PERIOD ?time .\n\t?obs dim:dim-geo ?g .\n\t?g skos:prefLabel ?geo .\n\t?obs <ds/" + id + "#measure-OBS_VALUE> ?value .\n\tFILTER (lang(?geo) = \"en\")\n}\nORDER BY ?geo";
            // String query =
            ...
            ch.writeCharacters("../ds/" + id);
            ch.writeEndElement();
            ch.writeEndElement();
            ch.writeStartElement("dd");
            ch.writeCharacters("Data structure (");
            ch.writeStartElement("a");
            ch.writeAttribute(
                    "href",
                    Main.URI_PREFIX_3
            ...
            ch.writeCharacters("../dc/" + id);
            ch.writeEndElement();
            ch.writeEndElement();
            ch.writeStartElement("dd");
            ch.writeCharacters("Data constraint (");
            ch.writeStartElement("a");
            ch.writeAttribute(
                    "href",
                    Main.URI_PREFIX_3
            ...
            ch.writeStartElement("p");
            ch.writeStartElement("a");
            ch.writeAttribute("href", "https://yasgui.triply.cc/#query=" + URLEncoder.encode(query, "utf-8") + "&endpoint=" + URLEncoder.encode("https://estatwrap.ontologycentral.com/sparql", "utf-8"));
            ch.writeAttribute("target", "_blank");
            ch.writeCharacters("Open in YASGUI");
            ch.writeEndElement();
            ch.writeEndElement();
            ...
            ch.writeStartElement("p");
            ch.writeStartElement("a");
            ch.writeAttribute("href", "https://yasgui.triply.cc/#query=" + URLEncoder.encode(dsdquery, "utf-8") + "&endpoint=" + URLEncoder.encode("https://estatwrap.ontologycentral.com/sparql", "utf-8"));
            ch.writeAttribute("target", "_blank");
            ch.writeCharacters("Open in YASGUI");
            ch.writeEndElement();
            ch.writeEndElement();
            ...
            */
            ...
            //			ch.writeStartElement("a");
            //			ch.writeAttribute("href",
            // "http://appsso.eurostat.ec.europa.eu/nui/show.do?dataset=" + id
            // + "&lang=en");
