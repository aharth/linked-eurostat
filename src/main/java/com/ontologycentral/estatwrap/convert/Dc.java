...
/**
 * Download and convert DC (Data Constraint) files.
 *
 * @author aharth
 */
public class Dc {
    ...
    /**
     * Convert Data Constraint to RDF using XSLT transformation
     *
     * @param out Output stream to write the RDF to
     * @param xslPath Path to the XSLT stylesheet (e.g., "/WEB-INF/dc2rdf.xsl")
     * @throws IOException
    ...
    public void convert(Reader in, OutputStream out, String xslPath)
        ...
        _log.info("applying XSLT transformation for data constraint");
        t.transform(ssource, sresult);
    }

    /**
     * Convert Data Constraint to RDF using provided transformer
     *
     * @param out Output stream to write the RDF to
