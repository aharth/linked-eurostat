...
public class DataSdmx3Turtle {
    ...
    /** */
    public DataSdmx3Turtle(Reader sr) throws IOException {
        _in = new BufferedReader(sr);
    }

    /** */
    public void convertAlsoIsThatStillUsed(Writer out, String id) throws IOException {
        String line = null;
    ...
    public static void convertWithSdmx3IdentifiersToTurtle(OutputStream os, Map<String, String> toc, String id, Reader in)
        ...
        // HERE calls TSV conversion
        // Convert data using DataSdmx3Turtle
        DataSdmx3Turtle d = new DataSdmx3Turtle(in);
        d.convert(writer, id);
