...
/**
 * Download and convert DS (Data Structure) files.
 *
 * @author aharth
 */
public class Ds {
    ...
    /**
     * Convert Data Structure to RDF using XSLT transformation
     *
     * @param out Output stream to write the RDF to
     * @param xslPath Path to the XSLT stylesheet (e.g., "/WEB-INF/ds2rdf.xsl")
     * @throws IOException
    ...
    public void convert(Reader in, OutputStream out, String xslPath)
        ...
        _log.info("applying XSLT transformation for data structure");
        t.transform(ssource, sresult);
    }

    /**
     * Convert Data Structure to RDF using provided transformer
     *
     * @param out Output stream to write the RDF to
