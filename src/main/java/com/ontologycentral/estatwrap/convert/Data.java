...
public class Data {
    ...
    /** */
    public void printTriple(Header h, Line l, XMLStreamWriter out, int bnodeid, String id)
        ...
        if (start != 0 || end != hcol.size()) {
            ...
            out.writeCharacters(
                    "ATTENTION: file may be truncated due to processing time restrictions.");
            out.writeEndElement();
            out.writeEndElement();
        }
        ...
        for (int i = start; i < end; ++i) {
            ...
            for (int j = 0; j < hd1.size(); ++j) {
                if (hd1.get(j).equals("time")) {
                    ...
                    out.writeAttribute(
                            "rdf:resource", "../dic/" + hd1.get(j) + "#" + ld1.get(j));
                    out.writeEndElement();
                }
            }
            ...
            if (h.getDim2().equals("time")) {
                ...
                out.writeAttribute(
                        "rdf:resource", "../dic/" + h.getDim2() + "#" + hcol.get(i));
                out.writeEndElement();
            }
